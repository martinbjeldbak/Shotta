...
T["checkboxText.ZONE_CHANGED"] = "When entering a different zone, building, etc. (note: noisy!)"
...
T["checkboxText.CHAT_MSG_TEXT_EMOTE"] = "On all emotes with an emote token"
T["checkboxText.BOSS_KILL"] = "On boss kill, including raids"
T["checkboxText.ENCOUNTER_END"] = "At end of a dungeon or raid boss kill"
...
T["checkboxText.hideMinimap"] = "Hide minimap icon"
T["checkboxText.ACHIEVEMENT_EARNED"] = "Upon earning an achievement"
...
T["checkboxText.MAJOR_FACTION_RENOWN_LEVEL_CHANGED"] = "Renown level up"
T["about"] = "About"
